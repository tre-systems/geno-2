...
function writeSentryConfig(targetPath, version) {
  const config = {
    app: "geno-2",
  ...
  const contents = `// Auto-generated by scripts/gen-env.js
window.TRE_STATIC_SENTRY_CONFIG = ${JSON.stringify(config, null, 2)};
`;
  fs.writeFileSync(targetPath, contents, "utf8");
}
...
function main() {
  ...
  writeSentryConfig(path.join(pkgDir, "sentry-config.js"), version);
  console.log(
